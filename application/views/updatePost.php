<form action="/index.php/post/update/<?=$post->PK_POST_ID?>" class="post-input-group"  method="POST" enctype="multipart/form-data">
    <label for="post-input-title">Title</label>
    <textarea type="text" rows="1" maxlength="255" class="post-input" id="post-input-title"  name="title" ><?=$post->title?></textarea>
    <label for="post-input-subtitle">Subtitle</label>
    <textarea type="text" rows="2" maxlength="255" class="post-input" id="post-input-subtitle"  name="subtitle" ><?=$post->subtitle?></textarea>
    <label for="post-input-content">Content</label>
    <textarea class="post-input" id="post-input-content"  name="content" rows="4" cols="50"><?=$post->content?></textarea>
